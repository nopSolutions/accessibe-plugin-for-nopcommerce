...
public class AccessiBePlugin : BasePlugin, IWidgetPlugin
{
    ...
    public override async Task InstallAsync()
    {
        ...
        await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
        {
            ...
            ["Plugins.Widgets.AccessiBe.Fields.ShowTrigger"] = "Show Trigger Button",
            ["Plugins.Widgets.AccessiBe.Fields.ShowTrigger.Hint"] = "Option to Hide or Show the trigger button.",
